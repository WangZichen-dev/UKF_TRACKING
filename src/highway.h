...
public:
	...
	std::vector<bool> trackCars = {true,true,true,true};
	...
	Highway(pcl::visualization::PCLVisualizer::Ptr& viewer)
	{
		...
		Car car4(Vect3(13, 5, 0), Vect3(4, 2, 2), Color(0, 0, 1), 5, 0, 2, "car4");
		std::vector<accuation> car4_instructions;
		a = accuation(2.2*1e6, 0.0, -0.2);
		car4_instructions.push_back(a);
		a = accuation(3.3*1e6, 0.0, 0.2);
		car4_instructions.push_back(a);
		a = accuation(4.4*1e6, -2.0, 0.0);
		car4_instructions.push_back(a);
		car4.setInstructions(car4_instructions);
		if( trackCars[1] )
		{
			UKF ukf4;
			car4.setUKF(ukf4);
		}
		traffic.push_back(car4);
